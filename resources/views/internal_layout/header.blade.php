...
<head>
    ...
    <link rel="stylesheet" href="{!! url('assets/admin/plugins/bootstrap-colorpicker/dist/css/bootstrap-colorpicker.min.css') !!}">
    <!-- iCheck -->
    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="javascript:void(0)" class="logo">
                ...
                <span class="logo-mini"><b>IUSd</b></span>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <img src="{!! url('assets/front/upload/profile/blank.png') !!}" class="user-image" alt="User Image"/>
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header">
                                    <img src="{!! url('assets/front/upload/profile/blank.png') !!}" class="img-circle" alt="User Image" />
                                    <p>{{auth()->user()->username}}
                                    <small>Member since {{auth()->user()->regtime}}</small>
                                ...
                                <li class="user-footer">
                                    ...
                                    <div class="pull-right">
                                        <a href="{{ route('logout.perform') }}" class="btn btn-default btn-flat">Sign out</a>
                                    </div>
                                </li>
                            </ul>
                        </li>
