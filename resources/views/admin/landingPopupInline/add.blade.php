    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{ route('addlandingPopupInline.show') }}"> {{ $content_title }}</a></li>
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="box box-danger">
                        <div class="box-body">
                            <form action="{{ route('landingPopupInline.save') }}" method="POST" enctype="multipart/form-data" >
                                @csrf
                                <div class="row ">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="txtKeyword" id="txtKeyword" class="form-control"  value="" />
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="radio" name="radStatus" id="radStatus" value="2" />
                                    ...
                                    <div class="col-md-12">
                                        <div class="box-footer"> 
                                            ...
                                            <input type="button" name="btnButton" value="Back" class="btn vd_btn vd_bg-yellow" onclick="window.location.href='{{ route('landingPopupInline.show') }}'" /> &nbsp;
                                        </div>
                                    </div>
