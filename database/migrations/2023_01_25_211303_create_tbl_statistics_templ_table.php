...
class CreateTblStatisticsTemplTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_statistics_templ', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('tbl_statistics_templ');
    }
}
